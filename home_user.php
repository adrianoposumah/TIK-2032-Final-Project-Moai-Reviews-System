    ...
    <div class="movie-container">
      <?php foreach($features as $feature) : ?>
        <div class="movie-card">
            <a href="film-detail_user.php?id=<?= $feature['film_id'] ?>">
  ...
  <div class="coming-soon">
    ...
    <div class="movie-container">
      <?php foreach($comingsoons as $comingsoon) : ?>
        <div class="movie-card">
          <a href="film-detail_user.php?id=<?= $comingsoon['film_id'] ?>">
  ...
  <div class="anime">
    ...
    <div class="movie-container">
      <?php foreach($animes as $anime) : ?>
        <div class="movie-card">
          <a href="film-detail_user.php?id=<?= $anime['film_id'] ?>">
  ...
  <div class="anime">
    ...
    <div class="movie-container">
      <?php foreach($tvseries as $tvseri) : ?>
        <div class="movie-card">
          <a href="film-detail_user.php?id=<?= $tvseri['film_id'] ?>">
